...
def __ajouter_minifig(connexion:sqlite3.Connection, curseur:sqlite3.Cursor, id_minifig:int, id_rebrickable:str, nom:str, id_gamme:str) -> None :    #, image_ref:str
    ...
    connexion2 = sqlite3.connect(MOC)
    curseur2 = connexion2.cursor()
    image_ref = api.get_image_ref_minifig(id_minifig, id_rebrickable)
    print("image_ref :", image_ref)
    curseur.execute('''INSERT INTO Minifigures (id_minifig, id_rebrickable, nom, gamme, image_ref) VALUES (?, ?, ?, ?, ?);''', (id_minifig, id_rebrickable, nom, id_gamme, image_ref))
